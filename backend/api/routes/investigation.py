    ...
    return {
        ...
        "evidence_timeline": [
            ...
            },
            {
                ...
                "action": "asks",
                "detail": (
                    "→ Visual Agent: 'These three sellers appear related, "
            ...
            },
            {
                ...
                "action": "answers",
                "detail": (
                    "→ Seller Network Graph: 'Similarity score is 98%. "
                    "Same batch defect detected.'"
                ),
                "confidence_delta": 25,
            },
            {
                ...
                "action": "asks",
                "detail": (
                    "→ Price Agent: 'If an invoice existed, "
                    "would price still be suspicious?'"
                ),
                "confidence_delta": 0,
            },
            {
